 ...
 */
public class DialogViewSporthigh extends BaseView {
    private Button button;

    public DialogViewSporthigh(Context context) {
        super(context);
    }
    ...
    protected void initView() {
        View view = View.inflate(getContext(), R.layout.dialog_sporthigh, this);
