...
import dexin.love.band.adapter.PinnedSectionListAdapter;
...
public class PinnedSectionListView extends ListView {
	...
	void createPinnedShadow(int position) {
		...
		if (layoutParams == null) {
			...
			layoutParams = new LinearLayout.LayoutParams(generateDefaultLayoutParams.width, generateDefaultLayoutParams.height) ;
